...
struct ServeOptions {
    ...
    // Stream in-progress tool-call arguments as function_call_arguments.delta events (OpenAI
    // Responses protocol only; display-only, final state unchanged).
    bool stream_tool_args = false;
